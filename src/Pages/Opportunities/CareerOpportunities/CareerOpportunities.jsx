...
export default function CareerOpportunities() {
  ...
  const jobListings = [
    ...
    },
    {
      ...
      description: 'Creative designer needed for event promotional materials and digital content.'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description: 'Professional video editor for event coverage and promotional content.'
    },
    {
      id: 5,
      ...
      description: 'Social media expert to manage and grow our online presence.'
    },
    {
      id: 6,
      title: 'HR Specialist',
      ...
      description: 'HR professional to handle recruitment, training, and employee relations.'
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Join AnataEvents and build an amazing career
          </p>
        </div>
