  ...
  if (!event) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4 pt-28">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 text-center">Event Not Found</h1>
        <p className="text-gray-600 mb-6 text-center">ID: {id}</p>
        <a href="/services/ExhibitionEvent" className="btn btn-primary">
          Back to Exhibition Events
        </a>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 sm:py-12 pt-28">
      <div className="max-w-4xl mx-auto px-3 sm:px-4">
        {/* Back Button */}
        <a href="/services/ExhibitionEvent" className="btn btn-ghost btn-sm sm:btn-md gap-2 mb-6 sm:mb-8">
        ...
        <article className="bg-white rounded-lg shadow-lg p-4 sm:p-8 md:p-12">
              ...
              <div className="relative bg-gray-200 rounded-lg overflow-hidden mb-4">
                <div className="relative w-full h-48 sm:h-64 md:h-96">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src = 'https://via.placeholder.com/800x400?text=Exhibition+Event';
                    }}
                  />
                </div>
          ...
          {/* Category Badge */}
          <div className="mb-4">
            <span className="badge badge-primary">{event.category || 'Exhibition'}</span>
          </div>
            ...
            <div className="pt-8 sm:pt-12 border-t-2 border-gray-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                {relatedEvents.map(relatedEvent => {
                  ...
                  const relatedImage = relatedEvent.images?.[0] || relatedEvent.image || 'https://via.placeholder.com/400x300?text=Exhibition';
                  
                  return (
                    <a 
                      key={relatedEvent._id} 
                      href={`/services/exhibition-events/${relatedEvent._id}`}
                      className="group"
                    >
                      <div className="bg-gray-50 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full flex flex-col">
                        ...
                        <div className="p-3 sm:p-4 flex flex-col flex-grow">
                          <span className="badge badge-primary text-xs mb-2 w-fit">
                            {relatedEvent.category || 'Exhibition'}
                          </span>
...
export default ExhibitionEventDetails;